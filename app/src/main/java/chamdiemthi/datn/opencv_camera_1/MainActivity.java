...
public class MainActivity extends AppCompatActivity
    ...
    getSupportActionBar().setTitle("Quick Marker");
        Utils.init(this);
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (soCau != 20 && soCau != 40 && soCau != 60 && soCau != 80 && soCau != 100) {
                            Toast.makeText(MainActivity.this, "Number of answers must be equal to 20/40/60/80/100", Toast.LENGTH_SHORT).show();
                            return;
                        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (idSelected) {
            ...
            case R.id.nav_xem_diem:
                ...
                break;
            case R.id.nav_giay_thi:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/open?id=1GYqysZ8XcDesEJ2zwXmm2yin1j1TKuc8"));
