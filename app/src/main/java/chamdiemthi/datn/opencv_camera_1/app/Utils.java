...
public class Utils {
    ...
    public static String dateString(Date date) {
        return String.format("%s/%s/ at %s:%s", date.getDate(), date.getMonth() + 1, date.getHours(), date.getMinutes());
    }
...
//        Log.e("update: DiemThi", restore.toString());
    ...
    // chuyển byte sang lại bitmap để hiển thị ảnh trên tab xem lại
