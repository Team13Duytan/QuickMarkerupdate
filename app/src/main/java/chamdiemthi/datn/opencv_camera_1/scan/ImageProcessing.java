...
//    }
    ...
    // openCV sẽ xử lý ảnh lấy được ma trận sau đó lọc ma trận đó để lấy ra kết quả Số báo danh tương tự với mã đề + đáp án
